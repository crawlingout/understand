...
function handleSelectedText(a){var b={};b[from]=$selectedword.text();b[to]=$translatedword.text();a=a.trim();""!==a&&(1>=a.split(" ").length?(a=a.replace(/[,.?\u00bf!\u00a1:();\u201e\u201c\u201d\u201a\u2018\u2019"\u2039\u203a\u00ab\u00bb\u2014]/g,""),a!==b[from]&&($translatedword.text("..."),$whentoolong.addClass("hidden"),$selectedword.text(a),callBing(from,to,a),$translations.removeClass("hidden"),$linktodict.attr("href",linkToDict(a)))):($googletranslate.attr("href","https://translate.google.com/#"+
from+"/"+to+"/"+encodeURIComponent(a)),$whentoolong.removeClass("hidden"),$translations.addClass("hidden"),$selectedword.text("")),""!==b[from]&&"..."!==b[to]&&"ERROR"!==b[to]&&$previous_translated_words.is(":visible")&&prependPrevWord(b))}function setKnob(a,b){var c=b||stored_audio_time;$knob_player.trigger("configure",{max:a}).val(c).trigger("change")}
