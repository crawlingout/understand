...
loadDemo($(this).attr("id"));$("#from").val($(this).parent().data("lang"));$(".select_lang").change()});$("#tryitnow").click(function(){$("#more").removeClass("hidden");$("html, body").scrollTop(0)});$(".overlay").click(function(){$(".hidepopup").addClass("hidden");$("html, body").scrollTop(0)});$(".closepopup").click(function(){$(".hidepopup").addClass("hidden");$("html, body").scrollTop(0)});$("#show_video").click(function(){$("#video").removeClass("hidden");$("html, body").scrollTop(0)});window.onkeyup=
